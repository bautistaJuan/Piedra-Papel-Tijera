...
var _selectHand = require("./components/choose-game/selectHand");
...
},{"./components/choose-game/selectHand":"3eMiT","./components/timer/index":"1L0Sb","./components/button/my-button":"g8tqG","./router":"4QFWt"}],"3eMiT":[function(require,module,exports) {
var _state = require("../../state");
customElements.define("my-selection", class Hands extends HTMLElement {
    constructor(){
        super();
    ...
    render() {
        ...
        for (const hand of btn)hand.addEventListener("click", (e)=>{
            const btnOption = e.target;
            (0, _state.state).setMove(btnOption.textContent);
        });
    }
});
...
const state = {
    ...
    setState (newState) {
        this.data = newState;
        for (const functions of this.listeners)functions();
...
},{}],"1L0Sb":[function(require,module,exports) {
...
},{}],"g8tqG":[function(require,module,exports) {
...
function initHome(params) {
  ...
  <div class="container-title">
    ...
    imgUrl.forEach((img)=>{
        if (img.className == "papel") img.src = new URL(require("e7930894e3f1e529")).toString();
        else if (img.className == "piedra") img.src = new URL(require("c9cae88dce073d25")).toString();
        else if (img.className == "tijera") img.src = new URL(require("4bd941ccf9995c8e")).toString();
    });
...
},{"e7930894e3f1e529":"brq0R","c9cae88dce073d25":"ahMbM","4bd941ccf9995c8e":"5RLXy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"brq0R":[function(require,module,exports) {
module.exports = require("c82aa9887ea8991b").getBundleURL("7UhFu") + "papel.7e4765e7.png" + "?" + Date.now();

},{"c82aa9887ea8991b":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"ahMbM":[function(require,module,exports) {
